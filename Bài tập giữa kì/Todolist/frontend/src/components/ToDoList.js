...
const ToDoList = () => {
  ...
  const handleEdit = (task) => {
    console.log("task day nhes-----",task)
    setEditingTask(task);
  ...
  // Update task
  const handleUpdate = () => {
    console.log("day nhé 12334", editingTask)
  ...
  return (
    ...
    <>
      <div className="navbar">
        <div className="navbar-brand">My work 🎯</div>
